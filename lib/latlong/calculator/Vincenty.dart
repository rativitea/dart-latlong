...
class Vincenty implements DistanceCalculator {
  ...
  double distance(final google_maps.LatLng p1, final google_maps.LatLng p2) {
    ...
    double L = longitudeInRad(p2) - longitudeInRad(p1);
    double U1 = math.atan((1 - f) * math.tan(latitudeInRad(p1)));
    double U2 = math.atan((1 - f) * math.tan(latitudeInRad(p2)));
  ...
  google_maps.LatLng offset(final google_maps.LatLng from,
    ...
    final double latitude = latitudeInRad(from);
    final double longitude = longitudeInRad(from);
    ...
    return new google_maps.LatLng(radianToDeg(lat2), radianToDeg(lon2));
  }
